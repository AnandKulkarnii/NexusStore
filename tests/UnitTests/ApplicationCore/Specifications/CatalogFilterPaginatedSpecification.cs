...
namespace NexusStore.UnitTests.ApplicationCore.Specifications;
...
public class CatalogFilterPaginatedSpecification
{
    ...
    {
        var spec = new NexusStore.ApplicationCore.Specifications.CatalogFilterPaginatedSpecification(0, 10, null, null);
    ...
    {
        var spec = new NexusStore.ApplicationCore.Specifications.CatalogFilterPaginatedSpecification(0, 10, 1, 1);
